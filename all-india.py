...
#@nb.jit()
def getdata():
 a = pd.read_excel('AI and 4homo regions TS_harshit_Max.xlsx',engine='openpyxl')
 a = a.drop(['Column13','Column14','Column15','Column16','Column17'],axis = 1)
...
def p3(s4): #,s1,s2,s3,s4):
      # await asyncio.sleep(2)
       ...
       a = a[['YEAR','Column1','Column14','Column15','Column16','Column17']]
       ...
       f = px.bar(b,x='year',y='temperature(C)',color='seasons',color_discrete_sequence=['red','blue','green','goldenrod'])#,barmode='group')
